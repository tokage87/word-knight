...
const fireNodes: TreeNode[] = [
  ...
  },
  {
    ...
    label: 'Kula Ognia',
    desc: () => 'Odblokuj: płonąca eksplozja na całym ekranie',
    icon: 'assets/ui/Icon_01.png',
    maxRank: 1,
    costCurve: 'spellUnlock',
    effect: { kind: 'spellUnlock', spellId: 'fire' },
...
const waterNodes: TreeNode[] = [
  ...
  },
  {
    id: 'water.ice.unlock',
    label: 'Lodowa Iglica',
    desc: () => 'Odblokuj: obrażenia + spowolnienie wszystkich wrogów',
    icon: 'assets/ui/Icon_08.png',
    maxRank: 1,
    costCurve: 'spellUnlock',
    effect: { kind: 'spellUnlock', spellId: 'ice' },
    requires: ['water.spellDmg'],
    position: { q: -2, r: 1 },
  },
  {
    id: 'water.heal.unlock',
    label: 'Leczące Światło',
    desc: () => 'Odblokuj: uzdrowienie przy niskim HP',
    icon: 'assets/ui/Icon_04.png',
    maxRank: 1,
    costCurve: 'spellUnlock',
    effect: { kind: 'spellUnlock', spellId: 'heal' },
    requires: ['water.cdr'],
    position: { q: 2, r: 1 },
  },
  {
    id: 'water.blizzard.unlock',
    label: 'Zamieć Śnieżna',
    desc: () => 'Odblokuj: wielka burza — obrażenia + długie spowolnienie',
    icon: 'assets/ui/Icon_08.png',
    maxRank: 1,
    costCurve: 'spellUnlock',
    effect: { kind: 'spellUnlock', spellId: 'blizzard' },
...
const windNodes: TreeNode[] = [
  ...
  },
  {
    ...
    label: 'Ostrze Wiatru',
    desc: () => 'Odblokuj: szybki przeszywający podmuch (14 obr. × 3)',
    icon: 'assets/ui/Icon_05.png',
    maxRank: 1,
    costCurve: 'spellUnlock',
    effect: { kind: 'spellUnlock', spellId: 'windSlash' },
    requires: ['wind.atkSpd', 'wind.dodge'],
    position: { q: -1, r: 2 },
  },
  {
    id: 'wind.tornado.unlock',
    label: 'Wirująca Trąba',
    desc: () => 'Odblokuj: trwały wir — obrażenia przez 2s wszystkim wrogom',
    icon: 'assets/ui/Icon_10.png',
    maxRank: 1,
    costCurve: 'spellUnlock',
    effect: { kind: 'spellUnlock', spellId: 'tornado' },
...
const earthNodes: TreeNode[] = [
  ...
  },
  {
    ...
    label: 'Kamienna Tarcza',
    desc: () => 'Odblokuj: 2s nietykalności przy niskim HP',
    icon: 'assets/ui/Icon_06.png',
    maxRank: 1,
    costCurve: 'spellUnlock',
    effect: { kind: 'spellUnlock', spellId: 'stoneShield' },
    requires: ['earth.armor'],
    position: { q: -1, r: 2 },
  },
  {
    id: 'earth.quake.unlock',
    label: 'Trzęsienie Ziemi',
    desc: () => 'Odblokuj: potężna fala uderzeniowa + krótkie ogłuszenie',
    icon: 'assets/ui/Icon_01.png',
    maxRank: 1,
    costCurve: 'spellUnlock',
