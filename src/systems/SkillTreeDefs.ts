...
const fireNodes: TreeNode[] = [
  ...
  },
  {
    ...
    desc: (r) => `+${2 * r}% szansy na krytyk (×2 obrażenia)`,
    icon: 'assets/ui/Icon_08.png',
    maxRank: 3,
    costCurve: 'smallPassive',
    effect: { kind: 'stat', stat: 'critChance', perRank: 0.02 },
    requires: ['fire.dmg1'],
    position: { q: 2, r: 1 },
  },
  {
    id: 'fire.lifesteal',
    label: 'Pradawny Głód',
    desc: (r) => `+${1 * r}% leczenia z zadanych obrażeń`,
    icon: 'assets/ui/Icon_04.png',
    maxRank: 2,
    costCurve: 'mediumPassive',
    effect: { kind: 'stat', stat: 'lifesteal', perRank: 0.01 },
    requires: ['fire.hp1'],
    position: { q: -2, r: 1 },
  },
  {
...
const waterNodes: TreeNode[] = [
  {
    id: 'water.spellDmg',
    label: 'Moc Magii',
    desc: (r) => `+${5 * r}% obrażeń od zaklęć`,
    icon: 'assets/ui/Icon_10.png',
    maxRank: 3,
    costCurve: 'mediumPassive',
    effect: { kind: 'runStat', stat: 'spellDmg', perRank: 0.05 },
    requires: [],
    position: { q: -1, r: 0 },
  },
  {
    ...
    desc: (r) => `−${3 * r}% odnowy zaklęć`,
    icon: 'assets/ui/Icon_12.png',
    maxRank: 3,
    costCurve: 'mediumPassive',
    effect: { kind: 'runStat', stat: 'globalCooldown', perRank: 0.03 },
    requires: [],
    position: { q: 1, r: 0 },
  },
  {
...
const windNodes: TreeNode[] = [
  {
    id: 'wind.atkSpd',
    label: 'Zwinny Cios',
    desc: (r) => `−${2 * r}% czasu odnowy ataku`,
    icon: 'assets/ui/Icon_08.png',
    maxRank: 3,
    costCurve: 'mediumPassive',
    effect: { kind: 'stat', stat: 'atkSpd', perRank: 0.02 },
    requires: [],
    position: { q: -1, r: 0 },
  },
  {
  ...
  },
  {
    ...
    desc: (r) => `+${2 * r}% szansy na unik`,
    icon: 'assets/ui/Icon_09.png',
    maxRank: 2,
    costCurve: 'smallPassive',
    effect: { kind: 'stat', stat: 'dodgeChance', perRank: 0.02 },
...
const earthNodes: TreeNode[] = [
  ...
  },
  {
    id: 'earth.xpMult',
    label: 'Mądre Pióro',
    desc: (r) => `+${5 * r}% XP ze wszystkich źródeł`,
    icon: 'assets/ui/Icon_02.png',
    maxRank: 3,
    costCurve: 'bigPassive',
    effect: { kind: 'runStat', stat: 'xpMult', perRank: 0.05 },
    requires: [],
    position: { q: 1, r: 0 },
  },
  {
    ...
    desc: (r) => `+${3 * r}% redukcji obrażeń`,
    icon: 'assets/ui/Icon_06.png',
    maxRank: 2,
    costCurve: 'mediumPassive',
    effect: { kind: 'stat', stat: 'armor', perRank: 0.03 },
    requires: ['earth.hp2'],
    position: { q: -2, r: 1 },
  },
  {
  ...
  },
  {
    id: 'earth.gold',
    label: 'Skarby Zatoki',
    desc: (r) => `+${5 * r}% złota z wrogów`,
    icon: 'assets/ui/Icon_03.png',
    maxRank: 3,
    costCurve: 'smallPassive',
    effect: { kind: 'runStat', stat: 'goldMult', perRank: 0.05 },
